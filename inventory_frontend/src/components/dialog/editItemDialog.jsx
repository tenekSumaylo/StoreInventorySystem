...
import { UpdateProductApi } from "./../../Api/ProductClient";
export const EditItemDialog = (props) => {
    ...
    const handleSaveProduct = (e) => {
        ...
        console.log(props.id, productInformation);
        UpdateProductApi(props.id, productInformation)
        .then(response => {
                    ...
                    <Dialog.Positioner>
                        <Dialog.Content>
                                        ...
                                        <Box  w="100%" h="full" spaceY={5} display="flex" flexDirection="column" alignItems="center">
                                            ...
                                            alignItems="stretch" maxFiles={1} 
                                                ...
                                                onFileChange={ async (e) => {
                                                        ...
                                                        new Uint8Array(byteArr).reduce((data, byte) => data + String.fromCharCode(byte), '')
                                                        );
                            ...
                            <Dialog.Footer>
                                ...
                                <Button variant="solid" onClick={handleSaveProduct}>Save Product</Button>
                            </Dialog.Footer>
                        </Dialog.Content>
                    </Dialog.Positioner>
                </Dialog.Backdrop>
